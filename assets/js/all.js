...
//鍵盤事件檢查重複
if (inputBlock) {
  inputBlock.addEventListener("keypress", function (event) {
    if (event.which == 13) {
      before_addTods_checkSame();
    }
  });
